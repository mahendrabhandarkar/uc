...
API Gateway - Spring.cloud.starter.gateway, spring.boot.starter.actuator - Port Management - Access All services in single portal URL.
...
Netflix Eureka Server, Eureka Discovery Client [ For MicroServices Listing and there running status ], Ribbon, Hysterix [ Hysterix = Mitigating Latency and Managing Circuit Breaker thresholds. ], Zuul - 

Swagger, Kafka, MakerChecker [ Developing functionality for Granting rights to different users], ReactWeb - Start Youtube channel for Springboot teaching.
